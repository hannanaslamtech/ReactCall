...
import conf from "../src/assets/books.jpg";
    ...
    <div className="h-screen">
      ...
      <div className="relative  h-[90%]">
        ...
        <div className="absolute h-full w-full flex overflow-hidden">
          <img alt="LogoImg" src={conf} className="object-cover  w-full h-[full]" />
        </div>
        {/* Overlay */}
        <div className="absolute h-full w-full flex overflow-hidden bg-black/60"></div>
        {/* Hero Info */}
        <div className="lg:flex lg:pt-14 flex-col items-center justify-center relative z-10 px-6 md:max-w-[90vw] mx-auto">
          {/* Main */}
          ...
          <form
            onSubmit={submitCode}
            className="text-white md:pt-8 flex flex-col items-center justify-center"
          >
